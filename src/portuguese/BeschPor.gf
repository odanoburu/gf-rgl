...
-- 2 | r4
 ...
 {s = table {
    ...
    VPB (Pres Ind Pl P1) => x_ + "havemos" ;
    VPB (Pres Ind Pl P2) => x_ + "haveis" ;
...
-- 4 | r5
 ...
 {s = table {
    ...
    VPB (PretP Pl P1) => compr_ + "amos" ; --# notpresent
...
-- 12 | r23
 ...
 {s = table {
    ...
    VPB (PretP Pl P1) => x_ + "ficamos" ; --# notpresent
...
-- 13 | r24
 ...
 {s = table {
    ...
    VPB (PretP Pl P1) => come_ + "çamos" ; --# notpresent
...
-- 14 | r26
 ...
 {s = table {
    ...
    VPB (PretP Pl P1) => cheg_ + "amos" ; --# notpresent
...
-- 15 | r46
 ...
 {s = table {
    ...
    VPB (PretP Pl P1) => rec_ + "eamos" ; --# notpresent
...
-- 16 | r46
 ...
 {s = table {
    ...
    VPB (PretP Pl P1) => anunci_ + "amos" ; --# notpresent
...
-- 18 | r36
 ...
 {s = table {
    ...
    VPB (Pres Ind Sg P1) => comerc_ + "eio" ;
    VPB (Pres Ind Sg P2) => comerc_ + "eias" ;
    VPB (Pres Ind Sg P3) => comerc_ + "eia" ;
    VPB (Pres Ind Pl P1) => comerc_ + "iamos" ;
    VPB (Pres Ind Pl P2) => comerc_ + "iais" ;
    VPB (Pres Ind Pl P3) => comerc_ + "eiam" ;
    VPB (Pres Sub Sg P1) => comerc_ + "eie" ;
    VPB (Pres Sub Sg P2) => comerc_ + "eies" ;
    VPB (Pres Sub Sg P3) => comerc_ + "eie" ;
    VPB (Pres Sub Pl P1) => comerc_ + "iemos" ;
    VPB (Pres Sub Pl P2) => comerc_ + "ieis" ;
    VPB (Pres Sub Pl P3) => comerc_ + "eiem" ;
    ...
    VPB (PretP Pl P1) => comerc_ + "iamos" ; --# notpresent
    ...
    VPB (Imper Sg P2) => comerc_ + "eia" ;
    VPB (Imper Sg P3) => comerc_ + "eie" ;
    VPB (Imper Pl P1) => comerc_ + "iemos" ;
    VPB (Imper Pl P2) => comerc_ + "iai" ;
    VPB (Imper Pl P3) => comerc_ + "eiem" ;
    VPB (Imper Sg P1) => nonExist
    }
  } ;
...
-- 19 | r16
 ...
 {s = table {
    ...
    VPB (PretP Pl P1) => sa_ + "udamos" ; --# notpresent
...
-- 23 | r82
 ...
 {s = table {
    ...
    VPB (PretP Pl P1) => adequ_ + "amos" ; --# notpresent
...
-- 65 | r47
 ...
 {s = table {
    ...
    VPB (Pres Ind Sg P2) => refl_ + "etes" ;
    VPB (Pres Ind Sg P3) => refl_ + "ete" ;
    VPB (Pres Ind Pl P1) => refl_ + "etimos" ;
    VPB (Pres Ind Pl P2) => refl_ + "etis" ;
    VPB (Pres Ind Pl P3) => refl_ + "etem" ;
    ...
    VPB (PretI Ind Sg P1) => refl_ + "etia" ; --# notpresent
    VPB (PretI Ind Sg P2) => refl_ + "etias" ; --# notpresent
    VPB (PretI Ind Sg P3) => refl_ + "etia" ; --# notpresent
    VPB (PretI Ind Pl P1) => refl_ + "etíamos" ; --# notpresent
    VPB (PretI Ind Pl P2) => refl_ + "etíeis" ; --# notpresent
    VPB (PretI Ind Pl P3) => refl_ + "etiam" ; --# notpresent
    VPB (PretI Sub Sg P1) => refl_ + "etisse" ; --# notpresent
    VPB (PretI Sub Sg P2) => refl_ + "etisses" ; --# notpresent
    VPB (PretI Sub Sg P3) => refl_ + "etisse" ; --# notpresent
    VPB (PretI Sub Pl P1) => refl_ + "etíssemos" ; --# notpresent
    VPB (PretI Sub Pl P2) => refl_ + "etísseis" ; --# notpresent
    VPB (PretI Sub Pl P3) => refl_ + "etissem" ; --# notpresent
    VPB (MQPerf Sg P1) => refl_ + "etira" ; --# notpresent
    VPB (MQPerf Sg P2) => refl_ + "etiras" ; --# notpresent
    VPB (MQPerf Sg P3) => refl_ + "etira" ; --# notpresent
    VPB (MQPerf Pl P1) => refl_ + "etíramos" ; --# notpresent
    VPB (MQPerf Pl P2) => refl_ + "etíreis" ; --# notpresent
    VPB (MQPerf Pl P3) => refl_ + "etiram" ; --# notpresent
    VPB (PretP Sg P1) => refl_ + "eti" ; --# notpresent
    VPB (PretP Sg P2) => refl_ + "etiste" ; --# notpresent
    VPB (PretP Sg P3) => refl_ + "etiu" ; --# notpresent
    VPB (PretP Pl P1) => refl_ + "etimos" ; --# notpresent
    VPB (PretP Pl P2) => refl_ + "etistes" ; --# notpresent
    VPB (PretP Pl P3) => refl_ + "etiram" ; --# notpresent
    VPB (Fut Ind Sg P1) => refl_ + "etirei" ; --# notpresent
    VPB (Fut Ind Sg P2) => refl_ + "etirás" ; --# notpresent
    VPB (Fut Ind Sg P3) => refl_ + "etirá" ; --# notpresent
    VPB (Fut Ind Pl P1) => refl_ + "etiremos" ; --# notpresent
    VPB (Fut Ind Pl P2) => refl_ + "etireis" ; --# notpresent
    VPB (Fut Ind Pl P3) => refl_ + "etirão" ; --# notpresent
    VPB (Fut Sub Sg P1) => refl_ + "etir" ; --# notpresent
    VPB (Fut Sub Sg P2) => refl_ + "etires" ; --# notpresent
    VPB (Fut Sub Sg P3) => refl_ + "etir" ; --# notpresent
    VPB (Fut Sub Pl P1) => refl_ + "etirmos" ; --# notpresent
    VPB (Fut Sub Pl P2) => refl_ + "etirdes" ; --# notpresent
    VPB (Fut Sub Pl P3) => refl_ + "etirem" ; --# notpresent
    VPB (Cond Sg P1) => refl_ + "etiria" ; --# notpresent
    VPB (Cond Sg P2) => refl_ + "etirias" ; --# notpresent
    VPB (Cond Sg P3) => refl_ + "etiria" ; --# notpresent
    VPB (Cond Pl P1) => refl_ + "etiríamos" ; --# notpresent
    VPB (Cond Pl P2) => refl_ + "etiríeis" ; --# notpresent
    VPB (Cond Pl P3) => refl_ + "etiriam" ; --# notpresent
    VPB (Imper Sg P2) => refl_ + "ete" ;
    VPB (Imper Sg P3) => refl_ + "ita" ;
    VPB (Imper Pl P1) => refl_ + "itamos" ;
    VPB (Imper Pl P2) => refl_ + "eti" ;
...
-- 74 | r57
 ...
 {s = table {
    ...
    VPB (Pres Ind Sg P2) => destr_ + "óis" ;
    VPB (Pres Ind Sg P3) => destr_ + "ói" ;
    VPB (Pres Ind Pl P1) => destr_ + "uímos" ;
    VPB (Pres Ind Pl P2) => destr_ + "uís" ;
    VPB (Pres Ind Pl P3) => destr_ + "oem" ;
